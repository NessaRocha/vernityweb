  ...
  return (
    <div className="flex flex-col space-y-6 justify-center items-center md:items-start">
      ...
      >
        ...
        <svg className="w-6 h-6 relative z-10 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      >
        ...
        <svg className="w-6 h-6 text-black relative z-10 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
